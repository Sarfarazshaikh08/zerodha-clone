      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            ...
            <br />
            <a href="" style={{ textDecoration: "none" }}>Economic calendare</a>
            <br />
        ...
        <div className="row m-3 text-center" style={{ fontSize: "12px" }}>
           ...
           <div className="col"> <a href="" style={{ textDecoration: "none" }}>Privacy policy</a></div>
            ...
            <div className="col"><a href="" style={{ textDecoration: "none" }}>For investor's attention</a></div>
